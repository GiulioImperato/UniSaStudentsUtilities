...
public class TestDatabaseGM {
	...
	/**
	 * Testa il metodo doRetrieveAll() nel caso in cui c'è almeno una risorsa
	 * nel database
	 * 
	 * @throws SQLException
	...
	/**
	 * Testa il metodo doRetrieveAllByUtente nel caso in cui non esiste l'utente
	...
	/**
	 * Testa il metodo doRetrieveAllByUtente nel caso in cui esiste l'utente
	 * passato come parametro ed ha publicato almeno una risorsa
	 * 
	 * @throws SQLException
	 * @author Antonio Corsuto
	 */
	...
	/**
	 * Testa il metodo doRetrieveAllByUtente nel caso in cui esiste l'utente
	 * passato come parametro e non ha publicato nessuna risorsa
	 * 
	 * @throws SQLException
	 * @author Antonio Corsuto
	 */
	...
	/**
	 * Testa il metodo doRetrieveAllByPath nel caso in cui non esiste nessuna
	 * risorsa salvata con il path passato come parametro
	 * 
	 * @throws SQLException
	 * @author Antonio Corsuto
	 */
	...
	/**
	 * Testa il metodo doRetrieveAllByPath nel caso in cui esiste almeno una
	 * risorsa salvata con il path passsato come parametro
	 * 
	 * @throws SQLException
	 * @author Antonio Corsuto
	 */
	...
	/**
	 * Testa il metodo aggiornaLike nel caso in cui la risorsa esiste e il
	 * numerlo dei like è positivo
	 * 
	 * @throws SQLException
	 * @author Antonio Corsuto
	 */
	...
	/**
	 * Testa il metodo aggiornaLike nel caso in cui la risorsa non esiste e il
	 * numerlo dei like è negativo
	 * 
	 * @throws SQLException
	 * @author Antonio Corsuto
	...
	/**
	 * Testa il metodo aggiornaDislike nel caso in cui la risorsa esiste e il
	 * numerlo dei like è positivo
	 * 
	 * @throws SQLException
	 * @author Antonio Corsuto
	...
	/**
	 * Testa il metodo aggiornaDislike nel caso in cui la risorsa non esiste e
	 * il numerlo dei like è negativo
	 * 
	 * @throws SQLException
	 * @author Antonio Corsuto
	 */
	...
	/**
	 * Testa il metodo aggiornaDislike nel caso in cui la risorsa non esiste e
	 * il numerlo dei like è positivo
	 * 
	 * @author Antonio Corsuto
	 * @throws SQLException
	 * @throws Exception
