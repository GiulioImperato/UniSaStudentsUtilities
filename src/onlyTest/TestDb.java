...
public class TestDb {
	...
	public static void main(String[] args) throws SQLException {
		...
		/*
		 * ArrayList<Aula> array=DatabaseGA.getListaAule(); for(int
		 * i=0;i<array.size();i++){ System.out.println(array.get(i)); }
		 */
		/*
		 * Time i=new Time(9, 00, 00); Time f=new Time(10, 00, 00);
		 * ArrayList<OraAula> array=new ArrayList<>();
		 * array=DatabaseGA.visualizzaInfoAula("F1", Giorno.lun); for(int
		 * z=0;z<array.size();z++){ System.out.println(array.get(z)); }
		 */
		...
		// Risorsa risorsa=new Risorsa("materiale", "ang@hotmail.it", 10, data,
		// 5, 0, "src/banana");
		/*
		 * Time i=new Time(15, 00, 00); Time f=new Time(16,00,00); OraAula o=new
		 * OraAula("F1",Giorno.gio, i, f, false, true, "ang@hotmail.it");
		...
		// GestoreLibri gst = new GestoreLibri();
		// DatabaseGU.cambiaPassword("a.esposito164@studenti.unisa.it",
		// "gigginbaccola");
