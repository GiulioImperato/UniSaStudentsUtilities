...
public class GestoreAuleServlet extends HttpServlet {
	...
	/**
	 * <b>Permette di visualizzare la mappa con l'aggiunta delle aule
	 * (viewMap)</b> <b>Permette di visualizzare la mappa con le aule che
	 * risultano libere e occupate (statusAula)</b> <b>Permette di mostrare le
	 * informazioni di un'aula come nome e ore in cui l'aula risulta libera
	 * (infoAula)</b>
	 * 
