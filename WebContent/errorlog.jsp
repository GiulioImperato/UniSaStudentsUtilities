...
<div class="panel panel-default" style="padding:15px">
  ...
  <hr>
    <div class="panel-body" style="padding:10%; font-size:25px; color:#c9302c"><strong>Attenzione!</strong> Email o password errati.
    <br>
    <br>
    <br>
   <a href="reset.jsp" class="forgot-password">Hai dimenticato la password?</a>
   </div>
  </div>
</div>
</div>
